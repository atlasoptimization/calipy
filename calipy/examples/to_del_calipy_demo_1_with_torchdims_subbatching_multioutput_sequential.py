...
# # The following is functionality for standard tensortuples with matching batch_shapes.
# # It is useful in general but not helpful for the case of a tensortuplelist.
...
# convert to tensortuplelist with nones
...
data_tensortuplelist = data_list
...
output_data = data_tensortuplelist
input_data = None
...
data_list = [ (d1, d2) for d1, d2 in zip(data_1_aug, data_2_aug)]
data_tensortuplelist = (data_1_aug, data_2_aug)
...
# Create a DataLoader
# dataset_via_tensortuple = CalipyDataset(None, data_tensortuplelist, dataset_type = 'tensortuple')
dataset_via_tensortuplelist = CalipyDataset(input_data, output_data, dataset_type = 'tensortuplelist')

dataloader = DataLoader(dataset_via_tensortuplelist, batch_size=n_subbatch, shuffle=True, collate_fn=tensor_collate)
