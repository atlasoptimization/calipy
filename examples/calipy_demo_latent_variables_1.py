...
in noisy measurement obs. The length parameters mu_prod are random and unobserved,
they are so-called latent variables. Inference is performed to estimate the value
of the underlying mean and standard deviation of the production process and to 
infer the posterior distribution of the latent variables.
